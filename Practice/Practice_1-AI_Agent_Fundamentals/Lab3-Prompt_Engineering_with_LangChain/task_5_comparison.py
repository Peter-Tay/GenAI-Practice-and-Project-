...
def main():
    ...
    # Set the test problem for all techniques
    ...
    # Apply zero-shot (just the problem, no examples)
...
Now create: {policy_type}""",
    ...
    # Apply one-shot with the example
    ...
    # Apply few-shot with multiple examples
